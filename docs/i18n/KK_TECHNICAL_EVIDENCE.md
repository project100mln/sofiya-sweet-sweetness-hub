...
| Translator surface        | Reproducible `KK_TRANSLATION_REGISTER.tsv` with 632 source/draft/context rows; freshness check in `npm run check`                      |
...
- Translation-register freshness: PASS — 632 rows
