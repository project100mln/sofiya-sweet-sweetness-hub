      ...
      <div className="container-page py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li>
              <Link to="/stores" className="text-white/85 hover:text-[color:var(--gold)]">
                Магазины
              </Link>
            </li>
            <li>
              <Link to="/cake-preorder" className="text-white/85 hover:text-[color:var(--gold)]">
                Торты на заказ
              </Link>
            </li>
            <li>
              <Link to="/catering" className="text-white/85 hover:text-[color:var(--gold)]">
                Кейтеринг
              </Link>
            </li>
            <li>
              <Link to="/promotions" className="text-white/85 hover:text-[color:var(--gold)]">
                Акции
              </Link>
            </li>
            <li>
              <Link to="/news" className="text-white/85 hover:text-[color:var(--gold)]">
                Новости
              </Link>
            </li>
            <li>
              <Link to="/career" className="text-white/85 hover:text-[color:var(--gold)]">
                Карьера
              </Link>
            </li>
          </ul>
