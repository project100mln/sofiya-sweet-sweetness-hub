...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "SOFIYA Sweet — фирменные торты, свежая выпечка, завтраки, пицца и кофе. 16 пекарен и кофеен в Шымкенте, Ленгере, Аксукенте, Сайраме и Манкенте." },
      ...
      { name: "twitter:description", content: "SOFIYA Sweet — фирменные торты, свежая выпечка, завтраки, пицца и кофе. 16 пекарен и кофеен в Шымкенте, Ленгере, Аксукенте, Сайраме и Манкенте." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39fb9dd9-d402-4b39-aacb-e7c75e52e223/id-preview-0d3c6c41--a2dc33b6-dee8-414d-bb74-5140bccf959f.lovable.app-1783422170040.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39fb9dd9-d402-4b39-aacb-e7c75e52e223/id-preview-0d3c6c41--a2dc33b6-dee8-414d-bb74-5140bccf959f.lovable.app-1783422170040.png" },
    ],
    links: [
