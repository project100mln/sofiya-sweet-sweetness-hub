...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SOFIYA — растущая казахстанская сеть кофеен и пекарен. Свежая выпечка, фирменные торты и кофе каждый день." },
    ],
  }),
  component: AboutPage,
});
      ...
      <section className="container-page py-14">
        <div className="rounded-3xl bg-[color:var(--cream)] p-8 md:p-12 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            <Link to="/career" className="btn-outline btn-outline-hover">Работать в SOFIYA</Link>
          </div>
        </div>
      </section>
    </>
