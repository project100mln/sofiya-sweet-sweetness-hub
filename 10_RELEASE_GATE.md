...
| Translation coverage     | Typed UI registry plus reproducible 645-row `docs/i18n/KK_TRANSLATION_REGISTER.tsv`; 53 products, 9 categories, 17 stores, 3 news items and 2 promotions | Codex                                 | Implemented; human wording review pending     |
| SSR/SEO/sitemap          | Self-starting verifier checks 75 RU + 75 KK pages, exact canonicals/hreflang, 450 sitemap alternates, JSON-LD and localized 404s                         | Codex                                 | Local PASS; candidate/preview recheck pending |
