...
| Translation coverage     | Typed UI registry plus reproducible 632-row `docs/i18n/KK_TRANSLATION_REGISTER.tsv`; 53 products, 9 categories, 17 stores, 3 news items and 2 promotions | Codex                                 | Implemented; human wording review pending     |
